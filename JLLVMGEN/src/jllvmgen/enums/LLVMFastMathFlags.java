...
public enum LLVMFastMathFlags
{
	 ...
	 * If an argument is a nan, or the result would be a nan, it produces a poison
	 * value instead.
	 */
	nnan,
	/**
	 * No Infs - Allow optimizations to assume the arguments and result are not
	 * +/-Inf. If an argument is +/-Inf, or the result would be +/-Inf, it produces
	 * a poison value instead.
	 */
	ninf,
	/**
	 * No Signed Zeros - Allow optimizations to treat the sign of a zero argument or
	 * result as insignificant. This does not imply that -0.0 is poison and/or
	 * guaranteed to not exist in the operation.
	 */
	nsz,
	/**
	 ...
	 * to form arbitrary contractions. For example, (a*b) + (c*d) + e can not be
	 * transformed into (a*b) + ((c*d) + e) to create two fma operations.
	 */
	contract,
	/**
	...
	afn,
	/**
	 * Allow reassociation transformations for floating-point instructions. This may
	 * dramatically change results in floating-point.
	 */
	reassoc,
	/**

...
public class LLVMTruncToInst implements ILLVMBaseInst
{
	private LLVMDataValue result;
	private LLVMDataValue value;
	
	private LLVMTruncToInst(LLVMFunction fn, LLVMDataValue value, ILLVMMemoryType type) throws LLVMException
	{
		if (fn == null)
	...
	public static LLVMTruncToInst create(LLVMFunction fn, LLVMDataValue value, ILLVMMemoryType type) throws LLVMException
	{
		var instruction = new LLVMTruncToInst(fn, value, type);
	...
	public static LLVMTruncToInst create(LLVMFunction fn, LLVMLabelType parentLabelType, LLVMDataValue value, ILLVMMemoryType type) throws LLVMException
	{
		var instruction = new LLVMTruncToInst(fn, value, type);

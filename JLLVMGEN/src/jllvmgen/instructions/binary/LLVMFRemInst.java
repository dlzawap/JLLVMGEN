...
public class LLVMFRemInst implements ILLVMBaseInst
{
	...
	{
		var instruction = new LLVMFRemInst(fn, op1, op2, null);
	...
	{
		var instruction = new LLVMFRemInst(fn, op1, op2, fastMathFlags);
	...
	public static LLVMFRemInst create(LLVMFunction fn, LLVMLabelType parentLabelType, LLVMDataValue op1, LLVMDataValue op2) throws LLVMException
	{
		var instruction = new LLVMFRemInst(fn, op1, op2, null);
	...
	public static LLVMFRemInst create(LLVMFunction fn, LLVMLabelType parentLabelType, LLVMDataValue op1, LLVMDataValue op2, LLVMFastMathFlags... fastMathFlags) throws LLVMException
	{
		var instruction = new LLVMFRemInst(fn, op1, op2, fastMathFlags);

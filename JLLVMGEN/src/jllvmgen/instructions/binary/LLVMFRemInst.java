...
public class LLVMFRemInst implements ILLVMBaseInst
{
	...
	public static LLVMFRemInst create(LLVMFunction fn, LLVMLabelType label, LLVMDataValue op1, LLVMDataValue op2) throws LLVMException
	{
		var instruction = new LLVMFRemInst(fn, op1, op2, null);
	...
	public static LLVMFRemInst create(LLVMFunction fn, LLVMLabelType label, LLVMDataValue op1, LLVMDataValue op2, LLVMFastMathFlags... fastMathFlags) throws LLVMException
	{
		var instruction = new LLVMFRemInst(fn, op1, op2, fastMathFlags);

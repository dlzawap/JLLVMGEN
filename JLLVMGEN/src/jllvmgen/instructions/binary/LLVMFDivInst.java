...
public class LLVMFDivInst implements ILLVMBaseInst
{
	...
	private LLVMFDivInst(LLVMFunction fn, LLVMDataValue op1, LLVMDataValue op2, LLVMFastMathFlags[] fastMathFlags) throws LLVMException
	{
		if (fn == null)
	...
	{
		var instruction = new LLVMFDivInst(fn, op1, op2, null);
	...
	{
		var instruction = new LLVMFDivInst(fn, op1, op2, fastMathFlags);
	...
	public static LLVMFDivInst create(LLVMFunction fn, LLVMLabelType parentLabelType, LLVMDataValue op1, LLVMDataValue op2) throws LLVMException
	{
		var instruction = new LLVMFDivInst(fn, op1, op2, null);
	...
	public static LLVMFDivInst create(LLVMFunction fn, LLVMLabelType parentLabelType, LLVMDataValue op1, LLVMDataValue op2, LLVMFastMathFlags... fastMathFlags) throws LLVMException
	{
		var instruction = new LLVMFDivInst(fn, op1, op2, fastMathFlags);

...
public class LLVMAndInst implements ILLVMBaseInst
{
	...
	private LLVMAndInst(LLVMFunction fn, LLVMDataValue op1, LLVMDataValue op2) throws LLVMException
	{
		if (fn == null)
	...
	public static LLVMAndInst create(LLVMFunction fn, LLVMLabelType parentLabelType, LLVMDataValue op1, LLVMDataValue op2) throws LLVMException
	{
		var instruction = new LLVMAndInst(fn, op1, op2);
